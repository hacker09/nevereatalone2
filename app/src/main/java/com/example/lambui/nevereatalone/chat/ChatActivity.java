package com.example.lambui.nevereatalone.chat;
...
import com.example.lambui.nevereatalone.adapter.MessageChatAdapter;
import com.example.lambui.nevereatalone.R;
import com.example.lambui.nevereatalone.notification.Utilities;
