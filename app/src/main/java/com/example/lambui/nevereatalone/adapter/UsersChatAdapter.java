package com.example.lambui.nevereatalone.adapter;
...
import com.example.lambui.nevereatalone.ExtraIntent;
import com.example.lambui.nevereatalone.R;
import com.example.lambui.nevereatalone.User;
import com.example.lambui.nevereatalone.chat.ChatActivity;
import com.example.lambui.nevereatalone.chat.ChatHelper;
