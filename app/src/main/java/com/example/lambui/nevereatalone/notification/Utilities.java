package com.example.lambui.nevereatalone.notification;

import android.content.Context;

import com.example.lambui.nevereatalone.notification.Notification;
...
public class Utilities {
    public static void sendNotification(final Context context, String user_id, String message, String description, String type){
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("notifications").child(user_id);
